...
const Marvel = ({toys}) => {
    ...
    return (
        <div className='flex justify-center'>
            ...
            {
                    marvelToys.map(toy=> <div className="card card-compact w-50 bg-black  mx-5  mb-5 p-5 shadow-xl text-gray-200 font-serif flex flex-col justify-center" key= {toy._id}>
