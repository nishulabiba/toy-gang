  ...
  const {user} = useContext(AuthContext)
    ...
    return (
        <div className=' grid grid-cols-3 place-content-center w-5/6 place-items-center mx-28 '>
            ...
            {
                    avengersToys.map(toy=> <div className="card card-compact w-50 bg-white text-zinc-700  mx-5  mb-5 p-5 shadow-xl  font-serif flex flex-col justify-center" key= {toy._id}>
                    ...
                    {user?
                       ...
                       <input type="checkbox" id={toy._id} className="modal-toggle" />
                              <div className="modal">
                              <div className="modal-box w-3/5 h-4/5 p-10 max-w-5xl bg-white flex flex-col justify-center items-center gap-1">
